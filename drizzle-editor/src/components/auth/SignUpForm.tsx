      ...
      <div className="relative z-10 w-full max-w-sm mx-auto">
        <div className="border border-neutral-200 dark:border-neutral-800 rounded-2xl bg-white dark:bg-neutral-950 overflow-hidden">
          ...
          <div className="px-7 py-8 flex flex-col items-center text-center gap-4">
            <div className="w-12 h-12 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-900 flex items-center justify-center text-emerald-500">
              <MailCheck size={22} />
            </div>
            <p className="text-[13px] text-neutral-500 dark:text-neutral-400 max-w-[240px]">
              Click the link in your email to confirm your account, then log in.
            </p>
            <Link
              to="/login"
              className="text-[13px] font-medium text-emerald-600 dark:text-emerald-400 hover:underline"
            >
              Back to sign in
            </Link>
          </div>
    ...
    <div className="relative z-10 w-full max-w-sm mx-auto">
      <div className="border border-neutral-200 dark:border-neutral-800 rounded-2xl bg-white dark:bg-neutral-950 overflow-hidden">
        ...
        <div className="px-7 pt-7 pb-6 border-b border-neutral-200 dark:border-neutral-800">
          ...
          <p className="text-[13px] text-neutral-500 dark:text-neutral-400 mt-1">
            Build and visualize your first schema in minutes.
          </p>
        </div>
